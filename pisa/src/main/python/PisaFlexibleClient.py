...
class IsaFlexEnv:
    def __init__(self, port, isa_path="/Applications/Isabelle2020.app/Isabelle",
    ...
    def proceed_to_line(self, line_string, before_after):
        ...
        try:
            ...
            print("Failure to proceed before/after line")
            print(e)
...
def parsed_json_to_env_and_dict(path_to_json, afp_path, port, isa_path="/Applications/Isabelle2020.app/Isabelle"):
