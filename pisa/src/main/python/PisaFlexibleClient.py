...
sys.path.append('/home/szymon/PycharmProjects/PISA_all/pisa/src/main/python')
...
class IsaFlexEnv:
    ...
    def initialise_env(self,port, isa_path, theory_file_path=None, working_directory=None):
